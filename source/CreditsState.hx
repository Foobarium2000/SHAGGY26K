...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		['Oliy', 'oily', 'Idea for 13K', 'https://gamebanana.com/members/1892224', 0xFF3D3449],
		[''],
		['13K+ Mod'],
		['Hydrenaline', 'hydre', 'Implemented 13K/16K/26K to the mod, Made some of the note assets', 'https://gamebanana.com/members/1617838', 0xFF7027AD],
